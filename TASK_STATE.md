...
| 1 | P0 capabilities (SQLite reader + calendar lifecycle + ReminderKit helper integration + subtasks + flagged + tags + sections) | 🟡 partial | S1.0 ✅, S1.1 ✅, S1.2 ✅; S1.3-1.8 pending |
